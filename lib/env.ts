...
export const ENV_CONFIG = {
  ...
  CHAMPIONS_CACHE_TIME: parseInt(process.env.NEXT_PUBLIC_CHAMPIONS_CACHE_TIME || '300000'), // 5 minutes
  TAGS_CACHE_TIME: parseInt(process.env.NEXT_PUBLIC_TAGS_CACHE_TIME || '600000'), // 10 minutes
